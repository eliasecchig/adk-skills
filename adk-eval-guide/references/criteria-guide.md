...
- `judge_model` — model used for judging (default: `gemini-2.5-flash`)
...
Define custom Python functions as metrics in `test_config.json`:
...
- WebFetch: `https://google.github.io/adk-docs/evaluate/criteria.md`
